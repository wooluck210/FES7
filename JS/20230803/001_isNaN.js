...
// "p2o4i8gj2"
// 암기: isNaN은 Number로 숫자변환이 가능한 값을 false로 준다! 즉, 숫자를 false로 준다.
// !isNaN(value[0]) 숫자를 걸러내는 방법
let valueMain = "p2o4i8gj2"

isNaN(valueMain[0]) // p, true
isNaN(valueMain[1]) // 2, false
isNaN(valueMain[2]) // o, true
// ...생략...
