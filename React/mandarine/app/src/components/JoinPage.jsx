...
const JoinPage = ({handlePage})=>{
  ...
  const [imgSrc, setImgSrc] = useState('https://mandarin.api.weniv.co.kr/Ellipse.png')
  ...
  return(
      <>
      <button type="button" onClick={handlePage}>로그인 하기</button>
      <section >
          <h2 >이메일로 회원가입</h2>
          <div >
      ...
      <section>
          ...
          <input type="file" id="profileImg" name="image" accept="image/*" className="ir" onChange={handleChangeImage} />
          <div >
          ...
          <div>
              ...
              <input type="text" id="userIntroInput" name="intro" placeholder="자신과 판매할 상품에 대해 소개해 주세요." onChange={inputInfo}/>
          </div>
